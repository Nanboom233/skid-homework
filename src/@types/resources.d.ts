export default interface Resources {
  "commons": {
    ...
    "init-page": {
      "advanced": {
        "description": "微调你的体验。所有设置都可以稍后在设置中更改。",
        "fallback": {
          "label": "备用模型",
          "no-models": "请先配置 API 密钥以查看可用模型。",
          "none": "无",
          "tip": "主模型失败时自动切换到此模型。"
        },
        "max-retries": {
          "label": "最大重试次数",
          "tip": "API 调用失败时的最大自动重试次数（0-10）。"
        },
        "online-search": "在线搜索",
        "online-search-tip": "允许 AI 搜索网络获取额外上下文。",
        "thinking-budget": {
          "label": "思考预算",
          "tip": "AI 推理的最大 Token 数（仅 Gemini）。",
          "unit": "tokens"
        },
        "title": "高级设置"
      },
      "ai-config": {
        ...
        "status": {
          ...
          "errors": {
            "auth": "API 密钥无效或访问被拒绝。",
            "network": "连接失败，请检查地址和网络。",
            "rate-limit": "请求频率受限，请稍后重试。",
            "unknown": "连接失败，请检查密钥和地址。"
          },
          "loading": "正在验证 API 密钥..."
        },
    ...
    "settings-page": {
      ...
      "model": {
        ...
        "show-selector-in-scan-page": "在扫描页面显示模型选择以快速切换模型",
        "title": "模型配置"
      },
      "openai": {
        "poll-interval": {
      ...
      "thinking": {
        ...
        "online-search": {
          ...
          "show-toggle-in-scan-page": "在扫描页面显示联网搜索按钮以快速切换",
          "title": "联网搜索设置",
          "toggle": {
            "disabled": "开启联网搜索",
            "enabled": "已开启联网搜索",
