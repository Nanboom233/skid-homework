...
import com.skidhomework.server.SocketRelay;
 ...
 */
public final class Nv21Encoder implements IEncoder {
                ...
                if (outputIndex >= 0) {
                    ...
                    if (outputBuffer != null && bufferInfo.size > 0) {
                        ...
                        if (nalDiagCount < NAL_DIAG_LIMIT
                                ...
                                && bufferInfo.size > 0) {
                            nalDiagCount++;
                            int nalType = (outputBuffer.get(bufferInfo.offset) & 0x1F);
    ...
    private void requestSyncFrame(String logMessage) {
        try {
            ...
            // Ignore sync-frame request failures; the outer first-frame wait
